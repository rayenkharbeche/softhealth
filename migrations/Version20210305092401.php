 ...
 */
final class Version20210305092401 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chambre CHANGE category_id category_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chambre CHANGE category_id category_id INT NOT NULL');
    }
}
